...
class AppraiseText:
    ...
    评价内容
    """
    def appraise_text(self, login, id, item, text=""):
        post_data = {"item": "%d" % item,
                     "explain": "%s" % text}
        ...
        appraise_text_url = "http://%s/activity/%d/feedback" % (ConfigFile().host(), id)
...
if __name__ == '__main__':
    ...
    _run = AppraiseText()
    print(_run.appraise_text(login, 69, 1))