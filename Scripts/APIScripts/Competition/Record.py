...
class Record:
    def record(self, login, id):
        ...
        record_url = "http://%s/activity/%d/record" % (ConfigFile().host(), id)
        ...
        try:
            ...
            log_list = [u'赛事详情', u"get", record_url, str(post_data), time, status_code, info]  # 单条日志记录
